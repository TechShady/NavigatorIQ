...
export const DEFAULT_APP_LINKS: Record<PersonaId, AppLink[]> = {
  developer: [
    { label: "Distributed Traces", appPath: "dynatrace.classic.distributed.traces", docsUrl: "https://docs.dynatrace.com/docs/observe/applications-and-microservices/distributed-traces", enabled: true },
    { label: "Services", appPath: "dynatrace.classic.services", docsUrl: "https://docs.dynatrace.com/docs/observe/applications-and-microservices/services", enabled: true },
  ...
  sre: [
    { label: "Problems", appPath: "dynatrace.classic.problems", docsUrl: "https://docs.dynatrace.com/docs/observe/davis-ai/problems", enabled: true },
    { label: "SLOs", appPath: "dynatrace.classic.slo", docsUrl: "https://docs.dynatrace.com/docs/observe/service-level-objectives", enabled: true },
  ...
  platform: [
    ...
    { label: "Hosts", appPath: "dynatrace.classic.hosts", docsUrl: "https://docs.dynatrace.com/docs/observe/infrastructure-monitoring/hosts", enabled: true },
  ...
  security: [
    { label: "Application Security", appPath: "dynatrace.classic.security.overview", docsUrl: "https://docs.dynatrace.com/docs/secure/application-security", enabled: true },
    { label: "Vulnerabilities", appPath: "dynatrace.classic.vulnerabilities", docsUrl: "https://docs.dynatrace.com/docs/secure/application-security/vulnerability-analytics", enabled: true },
    { label: "Attacks", appPath: "dynatrace.classic.attacks", docsUrl: "https://docs.dynatrace.com/docs/secure/application-security/attack-protection", enabled: true },
  ...
  dba: [
    { label: "Databases", appPath: "dynatrace.classic.databases", docsUrl: "https://docs.dynatrace.com/docs/observe/applications-and-microservices/databases", enabled: true },
    { label: "Distributed Traces", appPath: "dynatrace.classic.distributed.traces", docsUrl: "https://docs.dynatrace.com/docs/observe/applications-and-microservices/distributed-traces", enabled: true },
    { label: "Logs", appPath: "dynatrace.logs", docsUrl: "https://docs.dynatrace.com/docs/observe/logs", enabled: true },
    { label: "Dashboards", appPath: "dynatrace.dashboards", docsUrl: "https://docs.dynatrace.com/docs/observe/dashboards-and-notebooks/dashboards-new", enabled: true },
    { label: "Problems", appPath: "dynatrace.classic.problems", docsUrl: "https://docs.dynatrace.com/docs/observe/davis-ai/problems", enabled: true },
  ...
  network: [
    ...
    { label: "Smartscape Topology", appPath: "dynatrace.classic.smartscape", docsUrl: "https://docs.dynatrace.com/docs/observe/infrastructure-monitoring/smartscape", enabled: true },
    { label: "Infrastructure & Operations", appPath: "dynatrace.infraops", docsUrl: "https://docs.dynatrace.com/docs/observe/infrastructure-monitoring", enabled: true },
    { label: "Problems", appPath: "dynatrace.classic.problems", docsUrl: "https://docs.dynatrace.com/docs/observe/davis-ai/problems", enabled: true },
    { label: "Dashboards", appPath: "dynatrace.dashboards", docsUrl: "https://docs.dynatrace.com/docs/observe/dashboards-and-notebooks/dashboards-new", enabled: true },
  ],
  digital: [
    { label: "Digital Experience", appPath: "dynatrace.classic.rum.overview", docsUrl: "https://docs.dynatrace.com/docs/observe/digital-experience", enabled: true },
    { label: "Session Replay", appPath: "dynatrace.classic.session.segmentation", docsUrl: "https://docs.dynatrace.com/docs/observe/digital-experience/session-replay", enabled: true },
    { label: "Synthetic Monitoring", appPath: "dynatrace.classic.synthetic", docsUrl: "https://docs.dynatrace.com/docs/observe/synthetic-monitoring", enabled: true },
    { label: "Dashboards", appPath: "dynatrace.dashboards", docsUrl: "https://docs.dynatrace.com/docs/observe/dashboards-and-notebooks/dashboards-new", enabled: true },
  ...
  devops: [
    { label: "Workflows", appPath: "dynatrace.automations", docsUrl: "https://docs.dynatrace.com/docs/deliver/workflows", enabled: true },
    { label: "Releases", appPath: "dynatrace.classic.releases", docsUrl: "https://docs.dynatrace.com/docs/deliver/release-monitoring", enabled: true },
    { label: "OpenPipeline", appPath: "dynatrace.openpipeline", docsUrl: "https://docs.dynatrace.com/docs/manage/openpipeline", enabled: true },
    { label: "Kubernetes", appPath: "dynatrace.kubernetes", docsUrl: "https://docs.dynatrace.com/docs/observe/infrastructure-monitoring/container-platform-monitoring/kubernetes", enabled: true },
    { label: "Notebooks", appPath: "dynatrace.notebooks", docsUrl: "https://docs.dynatrace.com/docs/observe/dashboards-and-notebooks/notebooks", enabled: true },
  ],
