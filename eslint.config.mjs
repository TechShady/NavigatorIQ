...
const noRestrictedImportsDynatraceStratoRule = [
  ...
  {
    paths: [
      { name: "@dynatrace/strato-components-preview", message: "Please import from one of the sub packages." },
      { name: "@dynatrace/strato-components", message: "Please import from one of the sub packages." },
      { name: "@dynatrace/strato-design-tokens", message: "Please import from one of the sub packages." },
    ],
    patterns: [
      {
...
export default defineConfig([
  globalIgnores(["**/node_modules", "**/dist", "**/.dt-app", "**/app.config.*", "**/jest.*config.js", "**/eslint.config.mjs"]),
  {
    files: ["**/*.ts", "**/*.tsx"],
    ...
    rules: {
      ...
      "noSecrets/no-secrets": ["error", { additionalRegexes: { "Dynatrace Token": "dt0[a-zA-Z]{1}[0-9]{2}\\.[A-Z0-9]{8,24}\\.[A-Z0-9]{64}" } }],
